...
class BaseView: UIView{
    ...
    convenience init(with backgroundTheme: UIColor, circular: Bool, shadow: Bool, shadowStrength: Float,borderColor: UIColor?,borderThickness: Int?) {
        self.init()
    ...
    override func layoutSubviews() {
        ...
        if shadow{
            ...
            shadowLayer.shadowOpacity = shadowStrength
